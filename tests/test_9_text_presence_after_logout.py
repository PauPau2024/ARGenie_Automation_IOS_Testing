...
def test_home_screen_texts_present_after_logout(driver):
...
def test_login_screen_elements_after_logout(driver):
    assert click_button_by_accessibility(driver,"Session"), "Failed to click the 'Session' Button"
    # Array of text elements to check for on the meeting screen
    texts_to_check = [
        "Log in Required",
...
def test_profile_screen_texts_after_logout(driver):
